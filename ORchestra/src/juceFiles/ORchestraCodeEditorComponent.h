...
// Largely copied from JUCE juce_CodeEdtitorComponent.h
...
namespace ORchestra
{
    class ORchestraCodeEditorChangeListener
    {
        public:
            virtual void CodeEditorHasChanged() = 0;
    };

    class CodeTokeniser;

    class ORchestraCodeEditorComponent : public TextInputTarget,
                                            public Component,
    ...
    public:
        ...
        /** Creates an editor for a document.
            ...
            @see CodeDocument
        */
        ORchestraCodeEditorComponent (CodeDocument& document,
                             juce::CodeTokeniser* codeTokeniser);

        /** Destructor. */
        ~ORchestraCodeEditorComponent() override;
        ...
        */
        ...
        struct State
        {
            ...
            State (const ORchestraCodeEditorComponent&);
            ...
            void restoreState (ORchestraCodeEditorComponent&) const;
        ...
        */
        void setColourScheme (const juce::CodeEditorComponent::ColourScheme& scheme);

        /** Returns the current syntax highlighting colour scheme. */
        const juce::CodeEditorComponent::ColourScheme& getColourScheme() const noexcept    { return colourScheme; }
        ...
        */
        ...
        void AddChangeListener(ORchestraCodeEditorChangeListener* changeListener) { mChangeListener = changeListener; }

    private:
        //==============================================================================
        CodeDocument& document;
        ORchestraCodeEditorChangeListener* mChangeListener;
