...
// #else
    const juce::FontOptions MONOSPACE_FONT_OPTIONS{ juce::Font::getDefaultMonospacedFontName(), NORMAL_FONT_SIZE, juce::Font::bold };
    const juce::FontOptions BUTTON_FONT_OPTIONS{ juce::Font::getDefaultMonospacedFontName(), BUTTON_FONT_SIZE, juce::Font::bold };
// #endif
